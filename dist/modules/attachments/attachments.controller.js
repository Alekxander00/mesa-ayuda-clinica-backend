...
exports.viewImage = exports.getImageWithAuth = exports.downloadAttachment = exports.uploadAttachments = exports.getTicketAttachments = void 0;
...
const downloadAttachment = async (req, res) => {
    try {
        ...
        if (!fs_1.default.existsSync(absolutePath)) {
            ...
            const uploadsPath = path_1.default.join('uploads', path_1.default.basename(normalizedPath));
            if (fs_1.default.existsSync(uploadsPath)) {
                console.log(`✅ Archivo encontrado en ubicación alternativa: ${uploadsPath}`);
                res.setHeader('Content-Type', attachment.mime_type);
                res.setHeader('Content-Disposition', `attachment; filename="${attachment.filename}"`);
                return res.sendFile(path_1.default.resolve(uploadsPath));
            }
...
const getImageWithAuth = async (req, res) => {
    try {
        const { id } = req.params;
        const user = req.user;
...
exports.getImageWithAuth = getImageWithAuth;
